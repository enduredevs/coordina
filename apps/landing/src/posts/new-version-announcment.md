---
title: Introducing Coordina 2.0
date: "2022-04-08"
tags: ["announcement"]
draft: false
excerpt: A look at Coordina's first major update.
---
...
now but starting this year I've decided to focus more of my time on Coordina which has allowed
...
If you have any issue accessing your poll please reach out through the on-site chat or send an email to [support@coordina.co](mailto:support@coordina.co).
...
Coordina has always been mobile-friendly but it now has a more optimized view for smaller screens.
...
2. **Cost**&mdash;Sending out these emails isn't free and Coordina's user base has grown to the point that
...
There's plenty of new features coming so make sure to [follow me](https://twitter.com/imlukevella) or [@coordinaco](https://twitter.com/coordinaco) on Twitter for updates.
